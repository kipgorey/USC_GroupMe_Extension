...
var firebaseConfig = {
  apiKey: "AIzaSyBp9_ru681sTwPyVE8edKT-v9frOXVOt8Y",
  authDomain: "scgroupmedatabase.firebaseapp.com",
  projectId: "scgroupmedatabase",
  storageBucket: "scgroupmedatabase.appspot.com",
  messagingSenderId: "32371280354",
  appId: "1:32371280354:web:ba4c4af9df044572ba51bb",
  measurementId: "G-SGDXV5NEQX"
};
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
      chrome.tabs.executeScript(
        ...
        function (result) {
          ...
          /* ************* */
          /*  Planning to add a connection to a firebase database here to add the course id info and */
          /*  the url's for the already existing or newly created groupMe's */
          /* ************  */
          ...
          if (false) {
            ...
            let clientId = "hYV3KgET0h7hjbg8b7lRtyegiYtVnHxpuiaAsavU2yscbQGp";
            let redirectUri = "https://oauth.groupme.com/oauth/login_dialog?client_id=hYV3KgET0h7hjbg8b7lRtyegiYtVnHxpuiaAsavU2yscbQGp";
